...
const PROJECT_NAME = "طيباتي - Tayyibati";

const PRODUCT_IDENTIFIER = "tayyibati_premium_monthly";
const PLAY_STORE_PRODUCT_IDENTIFIER = "tayyibati_premium_monthly:monthly";

const PRODUCT_DISPLAY_NAME = "طيباتي بريميوم شهري";
const PRODUCT_USER_FACING_TITLE = "Tayyibati Premium Monthly";
const PRODUCT_DURATION = "P1M";

const APP_STORE_APP_NAME = "Tayyibati iOS";
const APP_STORE_BUNDLE_ID = "com.tayyibati.app";
const PLAY_STORE_APP_NAME = "Tayyibati Android";
const PLAY_STORE_PACKAGE_NAME = "com.tayyibati.app";
...
// $4.99/month — good starting price for a food/health app
const PRODUCT_PRICES = [
  { amount_micros: 4990000, currency: "USD" },
  { amount_micros: 4490000, currency: "EUR" },
  { amount_micros: 19990000, currency: "SAR" },
];
...
async function seedRevenueCat() {
  ...
  if (priceError) {
    ...
    console.log("Successfully added test store prices ($4.99/month)");
  }
