...
const styles = StyleSheet.create({
  ...
  addTitle: { fontSize: 16, fontFamily: "Tajawal_700Bold", textAlign: "right" },
  formInput: {
  ...
  statusChipText: { fontSize: 13, fontFamily: "Tajawal_700Bold" },
  addBtn: {
    paddingVertical: 12,
    borderRadius: 10,
    alignItems: "center",
  },
  addBtnText: { color: "#fff", fontFamily: "Tajawal_700Bold", fontSize: 15 },
  searchBar: {
  ...
  searchText: { flex: 1, fontSize: 14, fontFamily: "Tajawal_400Regular" },
  filterRow: { gap: 8 },
  filterChip: {
    paddingHorizontal: 14,
    paddingVertical: 6,
  ...
  foodNameAr: { fontSize: 14, fontFamily: "Tajawal_700Bold", textAlign: "right" },
  foodNameEn: { fontSize: 12, fontFamily: "Tajawal_400Regular", textAlign: "right" },
  foodReason: { fontSize: 11, fontFamily: "Tajawal_400Regular", textAlign: "right" },
  foodRight: { alignItems: "flex-end", gap: 6 },
  foodStatus: { fontSize: 11, fontFamily: "Tajawal_500Medium" },
